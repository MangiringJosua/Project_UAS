				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font">Tentang Bintang Raya!</h1>	
						</div>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2 class="cursive-font primary-color"><a href="../bpwl_wp">Sejarah</h2></a>
					<p>Rumah makan Bintang Raya didirikan pada tahun 2000 yang pada masa itu masih di pimpin oleh bapak Saharudin, dan sekarang telah 3 generasi rumah makan ini di pegang alih. Rumah makan ini memasak masakan khas padang. Beginilah fakta yg ada di bawah dari tahun 2000 hingga sekarang.</p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-center">
						...
						<span class="counter-label">Rata-rata rating</span>
				...
				<div class="col-md-12 text-center">
					...
					<div class="gtco-widget">
						...
						<ul class="gtco-social-icons">
							...
							<li><a href="loginadmin.php"><i class="icon-dribbble"></i></a></li>
						</ul>
					</div>
				</div>
