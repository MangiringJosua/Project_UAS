								...
								<div class="tab" >
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Masuk admin</h3>
											<form method="post">
												<div class="row form-group">
													...
													<div class="col-md-12">
														<label >Nama</label>
														<input type="text" name="user" id="text" value="" class="form-control">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Kata sandi</label>
														<input type="password" name="pass" id="text" class="form-control">
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" name="btnlogina" class="btn btn-primary btn-block" value="Masuk">
												<?php 
...
$con = mysqli_connect("localhost","root","","bintangraya");
	...
	if (isset($_POST['btnlogina'])) {
		...
		$cekloginadmin = mysqli_query($con,"SELECT * FROM admin WHERE user='$user'
			AND pass='$pass'");
		
	
		 if (mysqli_num_rows($cekloginadmin) == 1) {
			$_SESSION['user'] = $user;
